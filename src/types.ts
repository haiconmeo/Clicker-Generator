...
export interface BuildParams {
  ...
  /** Optional raised 3D decoration placed on top of the cap. */
  decorationColorRgb?: RGB;
  /** Multiplier applied after decoration auto-fit. 1 = default fitted size. */
...
export type GeometryRequest =
  ...
  | {
      ...
      outline: Ring[];
      params: BuildParams;
      decoration3mf?: ArrayBuffer | null;
    };
